...
#include "EraseLineMenuController.h"

EraseLineMenuController::EraseLineMenuController(EraseLineMenuModel *model, EraseLineMenuRender *render) {
    m_model = model;
    m_render = render;
}

void EraseLineMenuController::Run() {
    sf::Event event;
